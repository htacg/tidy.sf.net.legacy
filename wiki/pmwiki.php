...
if (file_exists('local/config.php'))
  { include('local/config.php'); $LocalConf=1; }
elseif (file_exists('local.php'))                            # deprecated 0.6
  { include('local.php'); $LocalConf=1; }                    # deprecated 0.6
elseif (file_exists('local/local.php'))                      # deprecated 0.6
  { include('local/local.php'); $LocalConf=1; }              # deprecated 0.6
...
function XLPage($lang,$p) {
  ...
  if ($xl) {
    if ($xl['xlpage-i18n']) {
      ...
      include_once("scripts/xlpage-$i18n.php");
    }
...
function HandleBrowse($pagename) {
  global $Text,$HTTP_GET_VARS,$PageRedirectFmt,$RedirectPattern,
